...
- (BOOL)openReturningError:(NSError **)error {
    ...
    if (![_inputSource readUInt32LittleEndian:&samplingFrequency error:nil] ||
        (samplingFrequency != kSFBSampleRateDSD64 &&
         samplingFrequency != kSFBSampleRateDSD128 &&
         samplingFrequency != kSFBSampleRateDSD256 &&
         samplingFrequency != kSFBSampleRateDSD512)) {
    ...
    case 4:
        ...
        break;
    case 5:
        channelLayout = [AVAudioChannelLayout layoutWithLayoutTag:kAudioChannelLayoutTag_DVD_10];
        break;
    case 6:
