...
- (NSArray<NSString *> *)artist {
    return [_metadata objectForKey:SFBAudioMetadataKeyArtist];
}

- (void)setArtist:(NSArray<NSString *> *)artist {
...
- (NSArray<NSString *> *)artistSortOrder {
    return [_metadata objectForKey:SFBAudioMetadataKeyArtistSortOrder];
}

- (void)setArtistSortOrder:(NSArray<NSString *> *)artistSortOrder {
