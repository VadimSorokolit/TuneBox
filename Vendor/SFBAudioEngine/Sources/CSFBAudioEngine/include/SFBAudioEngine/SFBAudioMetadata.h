...
/// The artist
@property(nonatomic, nullable) NSArray<NSString *> *artist;

/// The album title
@property(nonatomic, nullable) NSString *albumTitle;

/// The album artist
@property(nonatomic, nullable) NSArray<NSString *> *albumArtist;

/// The composer
@property(nonatomic, nullable) NSArray<NSString *> *composer;

/// The genre
@property(nonatomic, nullable) NSArray<NSString *> *genre;
...
@property(nonatomic, nullable) NSArray<NSString *> *artistSortOrder;

/// The album title sort order
@property(nonatomic, nullable) NSString *albumTitleSortOrder;

/// The album artist sort order
@property(nonatomic, nullable) NSArray<NSString *> *albumArtistSortOrder;

/// The composer sort order
@property(nonatomic, nullable) NSArray<NSString *> *composerSortOrder;

/// The genre sort order
@property(nonatomic, nullable) NSArray<NSString *> *genreSortOrder;
