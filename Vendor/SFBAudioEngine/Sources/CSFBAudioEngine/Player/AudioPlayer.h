...
class AudioPlayer final {
  ...
  private:
    ...
    enum class Flags : unsigned int {
        /// Playback has started and has not been stopped
...
#if TARGET_OS_IPHONE
    /// Requests the hardware sample rate matching `format` and waits briefly for it to take effect
    bool setPreferredAudioSessionSampleRateForFormat(AVAudioFormat *_Nonnull format, NSError **error) noexcept;
#endif /* TARGET_OS_IPHONE */
